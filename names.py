...
def make_full_name(given_name, family_name):
    ...
    if "-" in given_name: 
        ...
        given_name_part1 = names[0].capitalize()
        given_name_part2 = names[1].capitalize()
        given_name = given_name_part1 + "-" + given_name_part2

    elif "-" in family_name: 
        names = family_name.split("-")
 
        family_name_part1 = names[0].capitalize()
        family_name_part2 = names[1].capitalize()
        family_name = family_name_part1 + "-" + family_name_part2
