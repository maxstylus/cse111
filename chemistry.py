def main(): 
    ...
    # Get and print molecule name if recognized
    formula_name = get_formula_name(formula, known_molecules_dict)

    # Print the Formula name if found: 
    ...
    # Print proton total
    print(f"Sum of protons: {total_protons}")
...
def get_formula_name(formula, known_molecules_dict):
    ...
    """
    for molecule in known_molecules_dict.keys():

        if molecule == formula:
            formula_name = known_molecules_dict[molecule]
            break
        else: 
            formula_name = "Formula name is unknown."
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for item in symbol_quantity_list: 
        ...
        total_quantity = atomic_mass * quantity

        # Add the product into the total molar mass.
        total_molar_mass += total_quantity
...
def sum_protons(symbol_quantity_list, periodic_table_dict):
    ...
    for item in symbol_quantity_list: 
        ...
        # Get the atomic mass for the symbol from the dictionary.
        proton = periodic_table_dict[symbol][PROTONS_INDEX]   
        proton_total += proton
